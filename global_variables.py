...
g_data_folder = '/media/data' # modify if necessary
g_shapenet_root_folder = os.path.join(g_data_folder, 'ShapeNetCore.v1')    # modify if necessary
# g_pascal3d_root_folder = os.path.join(g_data_folder, 'pascal3d')
# g_sun2012pascalformat_root_folder = os.path.join(g_data_folder, 'sun2012pascalformat')
...
g_shape_synset_name_pairs = [('03691459', 'loudspeaker'),
                             ('03790512', 'motorbike'),
                             ('04090263', 'rifle'),
                             ('04256520', 'sofa'),
                             ('04379243', 'table'),
...
g_syn_images_folder = os.path.join(g_data_folder, 'view_sketch_data', 'view')
...
g_hostname_synset_idx_map = {socket.gethostname(): range(8)}

# # Crop and overlay is IO-heavy, running on local FS is much faster
# g_crop_hostname_synset_idx_map = {socket.gethostname(): range(19)}
# g_overlay_hostname_synset_idx_map = {socket.gethostname(): range(19)}
...
g_syn_light_environment_energy_lowbound = 0.8
